...
var VERSION_NUMBER_REGEX = /([\d.]+(?:-\w+[.\d]*)?(?:\+[\d.]+)?)$/;
var BASE_API_URL = "https://api.modrinth.com/v2";
var URL_GET_PROJECT_BASE = `${BASE_API_URL}/project`;
var URL_CREATE_VERSION = `${BASE_API_URL}/version`;
...
var RELATION_REQUIRED = "required";
var RELATION_OPTIONAL = "optional";
var RELATION_EMBEDDED = "embedded";
var RELATION_INCOMPATIBLE = "incompatible";
var ENV_CLIENT_AND_SERVER = "client_and_server";
var ENV_CLIENT_OR_SERVER = "client_or_server";
var ENV_CLIENT_OR_SERVER_PREF_BOTH = "client_or_server_prefers_both";
var ENV_CLIENT = "client_only";
var ENV_CLIENT_SERVER_OPTIONAL = "client_only_server_optional";
var ENV_SERVER = "server_only";
var ENV_SERVER_CLIENT_OPTIONAL = "server_only_client_optional";
var ENV_SINGLEPLAYER = "singleplayer_only";
var ENV_DEDICATED_SERVER = "dedicated_server_only";
var ENV_UNKNOWN = "unknown";
var ENVIRONMENTS = [
  ENV_CLIENT_AND_SERVER,
  ENV_CLIENT_OR_SERVER,
  ENV_CLIENT_OR_SERVER_PREF_BOTH,
  ENV_CLIENT,
  ENV_CLIENT_SERVER_OPTIONAL,
  ENV_SERVER,
  ENV_SERVER_CLIENT_OPTIONAL,
  ENV_SINGLEPLAYER,
...
var projectIdCache = /* @__PURE__ */ new Map();
async function main() {
